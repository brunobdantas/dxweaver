...
OutputBaseFilename=DXWeaver-0.5.0-Setup
...
Source: "..\dxweaver-package\settings\*"; DestDir: "{app}\settings"; Flags: ignoreversion recursesubdirs createallsubdirs onlyifdoesntexist
