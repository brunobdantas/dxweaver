#!/usr/bin/env python3
"""Fail-closed build-time integration patch for DXWeaver 0.5.1.
...
without changing the legacy compiler dialect. The v0.5.1 patch also makes the
DXWeaver cockpit a first-class child of MSHV's existing master QVBoxLayout and
ships the auditable dark design-system QSS.
"""
...
def apply(upstream: Path) -> None:
    ...
    native_autoseq = """    // DXWeaver 0.5.1: decoder -> intelligence -> native AutoSeq, entirely in-process.
